    ...
    offerings: [
      ...
      },
      {
        ...
        features: [
          ...
          "Outdoor reception setup",
          "Professional ushers",
          "Musical & cultural services",
    ...
    d.slug === "event-management"
      ? [
          ...
          },
          {
            ...
            title: "Funeral Planning & Management",
            description: "Dignity-focused funeral planning from condolences to final rites.",
            href: "/services/funeral-planning",
            highlights: ["Book of Condolences", "Vigil & church setup", "Ushers & catering"],
          },
          {
            id: "event-planning",
